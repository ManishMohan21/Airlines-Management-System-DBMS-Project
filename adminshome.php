...
<style>
html{
/* background-image:url("admin_home.jpeg");
background-size:100%;
color:white; */
}
.what{
...
<!-- <body  style="background-image: url('images/manage_airports.jpg');background-size:cover;"> -->
...
<br>
<center>
<p class="what" style="color:white"><b>WELCOME BACK ADMIN</b></p>
</center>
<div class="header">
    		<!-- <center>
    		<h3>Manage Flights,Airports and Planes</h3>
</center> -->
    	</div>
      <center>
			<h2 style="color:white"> <b>AIRLINE DATABASE MANAGEMENT SYSTEM</b></h2>
		</center>
